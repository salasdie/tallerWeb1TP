                ...
                <div class="content-wrapper">
                    ...
                    <div class="row page-title-header">
                        <div class="col-6">
                            <div class="page-header">
                                <h5 class="page-title">Nombre: ${nombre} </h5>

                            </div>
                        </div>
                        <div class="col-6">
                            <div class="page-header">
                                <h5 class="page-title">Apellido: ${apellido} </h5>
                    ...
                    <form:form action="modificarUsuario" method="POST" modelAttribute="usuario">
                        <div class="page-title">
                            <h5 class="page-item">Peso: ${peso} kg </h5>
                            <form:input path="peso" class="form-control" name="peso" id="pesoUsuario" type="text" placeholder="" />

                            <form:input path="id" class="form-control" name="peso"  type="hidden" id="id" placeholder="${idusuario}" />
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="page-title">
                                <h5 class="page-item">Altura: ${altura} m </h5>
                                <form:input  path="altura" class="form-control" name="altura" id="alturaUsuario" type="text" placeholder="" />
                            </div>
                        </div>

                    <div class="col-3">
                        <div class="page-title">
                            <h5 class="page-item">IMC: ${imc} </h5>
                        </div>
                    </div>
                </div>
                     <div class="col-3">
                        <div class="page-title">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-search"></i>Confirmar</button>
                        </div>
                    </div>
                </div>
                </form:form>
